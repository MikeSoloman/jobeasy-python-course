# Create three strings using three different methods.
# Save your result to result_string_1, result_string_2,
# result_string_3 variables

result_string_1 = "String 1"
result_string_2 = 'String 2'
result_string_3 = '''String 3'''


# Enter your first and  last name.
# Join them together with a space in
# between. Save a result in a variable result_full_name
# and
# save the length of the whole name in
# result_full_name_length variable.
...
# Enter the capital city of California State in lower case.
# Change the case to title case.
# Save the result in result_ca_capital variable

result_ca_capital = 'i don\'t know it'.capitalize()
